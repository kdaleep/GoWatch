<div class="col-md-9 p-4">
    <div class="card shadow-sm">
        <div class="d-flex justify-content-center bg-dark card-header bg-primary text-white">
            Manage Anime
        </div>
        <div class="card-body">
            <h5 class="card-title d-flex justify-content-end">

                <button class="btn btn-success" type="button" data-bs-toggle="modal" data-bs-target="#addModal">Add</button>
            </h5>
                        ...
                        <?php foreach ($data['movies'] as $anime): ?>
                            <tr>
                                ...
                                <td class="d-flex justify-content-center">
                                    <a href="/GoWatch/public/admin/anime/edit/<?= $anime['id'] ?>" class="btn btn-sm btn-primary">&nbsp; Edit &nbsp;</a>
                                </td>
                                <td class="d-flex justify-content-center">
                                    <a href="/GoWatch/public/admin/anime/delete/<?= $anime['id'] ?>" class="btn btn-sm btn-danger">Delete</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
